...
export default async function DocDetails({
  ...
  return (
    <div id="app-docs-show">
      <AppPageHeader title="Docs">
        <Button asChild>
          <Link href="/docs/">一覧に戻る</Link>
        </Button>
      </AppPageHeader>
          ...
          <div className="mt-6 flex justify-between items-center">
            <div className="flex-1 flex justify-center">
              <Link
                ...
                className="border border-black bg-white text-gray-800 px-6 py-1 rounded-md transition-colors hover:bg-indigo-100 hover:text-black"
              >
                内容変更
              </Link>
            </div>
