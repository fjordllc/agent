...
INSERT INTO docs (title, body, created_at, updated_at, user_id, last_updated_user_id) VALUES ('テスト', 'これはテストです。', NOW(), NOW(), 1, 1);
INSERT INTO docs (title, body, created_at, updated_at, user_id, last_updated_user_id) VALUES ('テスト', 'これはテストです。', NOW(), NOW(), 1, 2);
INSERT INTO docs (title, body, created_at, updated_at, user_id, last_updated_user_id) VALUES ('テスト', 'これはテストです。', NOW(), NOW(), 2, 2);
